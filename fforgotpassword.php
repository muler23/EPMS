...
<fieldset style="border: none;margin: 30px;">
    ...
    <form method="post"enctype="multipart/form-data">
      <label style="color: #006699;font-size: 20px;">የተጠቃሚ ስምህን አስገባ :</label><input type="text" placeholder="Search.." name="searchID" required="1" style="width: 200px;"/>
      <input type="submit" value="Search" name="search" class="myButtons">
  			...
  			if(isset($_POST['search']))
			   ...
			   <form method="POST" enctype="multipart/form-data">
			    <table>
			    <tr><td>የተጠቃሚ ስም</td><td><input type="username"  name="username" class="textbox" required="1" readonly="1" value="<?php echo $row['username'];?>"/> </td></tr> 
			    <tr><td>አዲስ የይለፍ ቃል  አስገባ :</td><td><input type="password"  name="newpassword" class="textbox"required></td></tr>
			    <tr><td>የይለፍ ቃል እንደገና አስገባ:</td><td><input type="password"  name="confirmnewpassword" class="textbox"required></td></tr>
