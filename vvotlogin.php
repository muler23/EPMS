		...
		?>
			...
			<div id="content">
				<div class="login">
						  ...
						  <h2 class="login-header">በዚህ ግባ</h2>
					 <form class="login-container" method="post" enctype="multipart/form-data">
					      	<p>የተጠቃሚ ስም:<input type="text" placeholder="username" name="username"required></p>
					      	<p>የይለፍ ቃል:<input type="password" placeholder="********" name="password" id="password" required></p>
					    	<p><input type="submit" value="Login" name="login"></p>
				            <label style="margin-left: 100px;float: right;margin-top: -50px;">
					        <input type="checkbox" name="checkbox" id="chekbox" onClick="show_password();">የይለፍ ቃሉ ይታይ
					        </label>
					       <P><a href="forgotpassword.php" style="text-decoration:none;font-style: italic;">የይለፍ ቃል ተረስቷል</a></P>
	...
	if(isset($_POST['login']))
     {
		...
		if($username==$uname&&$password==$pass)
		{
			...
			header("location:ssd/sSSD.php");
			else if($_SESSION['role']=="Candidate")
			header("location:candidate/cCandidate.php");
			else if($_SESSION['role']=="Voter")
			header("location:Voter/vVoter.php");
			else if($_SESSION['role']=="Main-Registrar")
			header("location:Main-Registrar/mMain-Registrar.php");
			else
...
{
echo "<font color=red>እባክዎ ትክክለኛ ስምና የይለፍ ቃል ያስገቡ </font>";
echo "<br>አራት እድል አልዎት። እስካሁን  $total ጊዜ ሞክረዋል";
