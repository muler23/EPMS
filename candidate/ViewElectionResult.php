...
include("../candidate/candidatemenu.php");
        ...
        while($row1=mysql_fetch_assoc($sql))
        {
                   ...
                   ?>
        <tr><td><?php echo $row1['candidate_id']; ?></td><td><?php echo $row1['fname'];?></td><td><?php echo $row1['age'];?></td><td><?php echo $row1['sex'];?></td><td><?php echo $row1['collage'];?></td><td><?php echo $row1['department'];?></td><td><?php echo $row1['year'];?></td><td><?php echo $row1['cgpa'];?></td><td><?php echo $row1['VOICE'];?></td><td><?php echo $rank;?></td><td>
          <?php echo $selected;?></td></tr>
				<?PHP
				$rank++;
				}
				?>
